if (
  ((function (e) {
    ...
    function r(e, s, a, r, n, l, o, d, c, p, u, m) {
      var f,
        h,
        g,
        v = m,
      ...
      return (
        l && (m = l(m)),
        !!i(m) &&
          (!1 !== e && 0 === parseFloat(m.toFixed(e)) && (m = 0),
          m < 0 && ((f = !0), (m = Math.abs(m))),
          !1 !== e &&
            (m = (function (e, t) {
              return (
          ...
          -1 !== (m = m.toString()).indexOf('.')
            ? ((g = (h = m.split('.'))[0]), a && (b = a + h[1]))
            : (g = m),
    ...
    function n(e, t, a, r, n, l, o, d, c, p, u, m) {
      var f,
        h = '';
      return (
        u && (m = u(m)),
        !(!m || 'string' != typeof m) &&
          (d && s(m, d) && ((m = m.replace(d, '')), (f = !0)),
          r && s(m, r) && (m = m.replace(r, '')),
          c && s(m, c) && ((m = m.replace(c, '')), (f = !0)),
          n &&
            (function (e, t) {
              return e.slice(-1 * t.length) === t;
            })(m, n) &&
            (m = m.slice(0, -1 * n.length)),
          t && (m = m.split(t).join('')),
          a && (m = m.replace(a, '.')),
          f && (h += '-'),
          '' !== (h = (h += m).replace(/[^0-9\.\-.]/g, '')) &&
            ((h = Number(h)), o && (h = o(h)), !!i(h) && h))
      );
    }
    function l(t, s, a) {
      var i,
      ...
      'object' == typeof s &&
        ((s = (function (t) {
          var s,
            ...
            r,
            n = {};
          for (void 0 === t.suffix && (t.suffix = t.postfix), s = 0; s < e.length; s += 1)
            if (void 0 === (r = t[(i = e[s])]))
              'negative' !== i || n.negativeBefore
                ? 'mark' === i && '.' !== n.thousand
                  ? (n[i] = '.')
                  : (n[i] = !1)
                : (n[i] = '-');
            else if ('decimals' === i) {
              if (!(0 <= r && r < 8)) throw new Error(i);
              n[i] = r;
            } else if ('encoder' === i || 'decoder' === i || 'edit' === i || 'undo' === i) {
              if ('function' != typeof r) throw new Error(i);
              n[i] = r;
            } else {
              if ('string' != typeof r) throw new Error(i);
              n[i] = r;
            }
          return (
            a(n, 'mark', 'thousand'),
            a(n, 'prefix', 'negative'),
            a(n, 'prefix', 'negativeBefore'),
            n
          );
        })(s)),
        (this.to = function (e) {
  ...
  (function (e, t) {
    ...
    var I = {
        updateSize: function () {
          ...
          const a = e.el;
          (t =
            void 0 !== e.params.width && null !== e.params.width ? e.params.width : a.clientWidth),
            (s =
        ...
        updateSlides: function () {
          ...
          if (
            (Object.assign(e, { slides: p, snapGrid: f, slidesGrid: g, slidesSizesGrid: v }),
      ...
      N = {
        ...
        loopFix: function (e) {
          ...
          if (r < h) {
            ...
            x = Math.max(r - (o.slides.length - 2 * h), m.slidesPerGroup);
            for (let e = 0; e < x; e += 1) {
              const t = e - Math.floor(e / d.length) * d.length;
              v.push(t);
            }
    ...
    function q(e) {
      ...
      let S = !0;
      u.matches(n.focusableElements) && ((S = !1), 'SELECT' === u.nodeName && (n.isTouched = !1)),
        s.activeElement &&
    ...
    function V(e) {
      ...
      r.oneWayMovement && ((v = Math.abs(v) * (o ? 1 : -1)), (b = Math.abs(b) * (o ? 1 : -1))),
        (n.diff = v),
        (v *= r.touchRatio),
        o && ((v = -v), (b = -b));
        ...
        v > 0
          ? (y &&
            ...
            i.currentTranslate > s.minTranslate() &&
              ...
              r.resistance &&
                (i.currentTranslate =
                  s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + v) ** E)))
          : v < 0 &&
            (y &&
              !S &&
              i.currentTranslate <
            ...
            i.currentTranslate < s.maxTranslate() &&
              ...
              r.resistance &&
                (i.currentTranslate =
                  s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - v) ** E))),
    ...
    function B(e) {
      ...
      if (
        ...
        (s.isMoved = !1),
        (s.startMoving = !1),
        (f = i.followFinger ? (o ? t.translate : -t.translate) : -s.currentTranslate),
        i.cssMode)
      )
        return;
      ...
      if (m > i.longSwipesMs) {
        ...
        'next' === t.swipeDirection &&
          (w >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? v : h + y) : t.slideTo(h)),
          ...
          : a.filter((e) => {
              const s = e.classList.contains('swiper-slide-transform')
                ? ((e) =>
                    e.parentElement
                      ? e.parentElement
                      : t.slides.filter((t) => t.shadowEl && t.shadowEl === e.parentNode)[0])(e)
                : e;
    ...
    const pe = [
      function (e) {
        ...
        function c(e) {
          ...
          (v = s.rtlTranslate ? 'right' : s.isHorizontal() ? 'left' : 'top'),
            i
              ? ((b = Math.floor(t / 2) + a + o), (w = Math.floor(t / 2) + a + l))
              : ((b = t + (a - 1) + o), (w = (r ? t : a) + l));
          let y = g - w,
            S = g + b;
          ...
          if (
            (r && g >= w
              ? ((y -= w), i || (x += s.slidesGrid[0]))
              : r && g < w && ((y = -w), i && (x += s.slidesGrid[0])),
      ...
      function (e) {
        ...
        function y(e) {
          ...
          let r;
          (r =
            (w(e) - v(i)[t.isHorizontal() ? 'left' : 'top'] - (null !== o ? o : d / 2)) / (c - d)),
        ...
        function T(e) {
          ...
          r[d]('pointerdown', S, n), l[d]('pointermove', x, n), l[d]('pointerup', E, o);
        }
        function M() {
        ...
        s({
          ...
          i('init', () => {
            !1 === t.params.scrollbar.enabled ? P() : (M(), b(), h());
          }),
      ...
      function (e) {
        ...
        function P(e) {
          ...
          let i, r, l, o, d, p, u, g, b, w, S, x, E, T, M, C, P, L;
          t.params.cssMode &&
        ...
        Object.defineProperty(t.zoom, 'scale', {
          ...
          Object.assign(t.zoom, { enable: _, disable: z, in: P, out: L, toggle: k });
      },
      function (e) {
        let { swiper: t, extendParams: s, on: a } = e;
        function i(e, t) {
      ...
      function (e) {
        ...
        function w(e) {
          i &&
            ...
            (i.wrapperEl.removeEventListener('transitionend', w), M());
        }
        const y = () => {
            if (i.destroyed || !i.autoplay.running) return;
            i.autoplay.paused ? (c = !0) : c && ((v = d), (c = !1));
            const e = i.autoplay.paused ? d : b + v - new Date().getTime();
        ...
        n('init', () => {
          ...
          Object.assign(i.autoplay, { start: x, stop: E, pause: T, resume: M });
      },
      function (e) {
                  ...
                  if (r.freeMode.momentum) {
                    ...
                    if (p < t.maxTranslate())
                      r.freeMode.momentumBounce
                        ? (p + t.maxTranslate() < -f && (p = t.maxTranslate() - f),
                          (u = t.maxTranslate()),
                          (m = !0),
                      ...
                      r.freeMode.momentumBounce
                        ? (p - t.minTranslate() > f && (p = t.minTranslate() + f),
                          (u = t.minTranslate()),
                          (m = !0),
                          (c.allowMomentumBounce = !0))
                        : (p = t.minTranslate()),
        ...
        le({
          ...
          setTranslate: () => {
            ...
            for (let s = 0; s < e.length; s += 1) {
              ...
              (S.style.transform = y),
                (S.style.opacity = w),
                h.origin && (S.style.transformOrigin = h.origin);
            }
          },
          setTransition: (e) => {
            const s = t.slides.map((e) => f(e));
            ...
            setTranslate: () => {
              ...
              for (let l = 0; l < e.length; l += 1) {
                ...
                const b = t.virtual && t.params.virtual.enabled ? t.virtual.from + l : l,
                  w =
                    (b === s || b === s - 1) && c > 0 && c < 1 && (r || t.params.cssMode) && n < i,
                  y =
                    (b === s || b === s + 1) && c < 0 && c > -1 && (r || t.params.cssMode) && n > i;
                if (w || y) {
  ...
  (function (e, t) {
    ...
    (e.PipsMode = void 0),
      ...
      (t.Values = 'values'),
      (e.PipsType = void 0),
      ((s = e.PipsType || (e.PipsType = {}))[(s.None = -1)] = 'None'),
      (s[(s.NoValue = 0)] = 'NoValue'),
      (s[(s.LargeValue = 1)] = 'LargeValue'),
      (s[(s.SmallValue = 2)] = 'SmallValue');
    var y = (function () {
        function e(e, t, s) {
          var a;
          (this.xPct = []),
          ...
          for (
            ...
            this.handleEntryPoint(i[a][1], i[a][0]);
          for (this.xNumSteps = this.xSteps.slice(0), a = 0; a < this.xNumSteps.length; a++)
            this.handleStepPoint(a, this.xNumSteps[a]);
        }
        return (
          ...
          (e.prototype.getAbsoluteDistance = function (e, t, s) {
            ...
            for (
              a = s
                ...
                : (this.xPct[i + 1] - e) / (this.xPct[i + 1] - this.xPct[i]);
              n > 0;

            )
              (l = this.xPct[i + 1 + c] - this.xPct[i + c]),
                t[i + c] * r + 100 - 100 * a > 100
                  ? ((o = l * a), (r = (n - 100 * a) / t[i + c]), (a = 1))
                  : ((o = ((t[i + c] * l) / 100) * r), (r = 0)),
                s
                  ? ((d -= o), this.xPct.length + c >= 1 && c--)
                  : ((d += o), this.xPct.length - c >= 1 && c++),
                (n = t[i + c] * r);
            return e + d;
          }),
          ...
          (e.prototype.getDefaultStep = function (e, t, s) {
            var a = v(e, this.xPct);
            return (
              (100 === e || (t && e === this.xPct[a - 1])) && (a = Math.max(a - 1, 1)),
              (this.xVal[a] - this.xVal[a - 1]) / s
            );
          }),
          ...
          (e.prototype.handleEntryPoint = function (e, t) {
            var s;
            if (!l((s = 'min' === e ? 0 : 'max' === e ? 100 : parseFloat(e))) || !l(t[0]))
              throw new Error("noUiSlider: 'range' value isn't numeric.");
            this.xPct.push(s), this.xVal.push(t[0]);
            var a = Number(t[1]);
            s ? this.xSteps.push(!isNaN(a) && a) : isNaN(a) || (this.xSteps[0] = a),
          ...
          (e.prototype.handleStepPoint = function (e, t) {
            if (t)
              if (this.xVal[e] !== this.xVal[e + 1]) {
                this.xSteps[e] =
                  g([this.xVal[e], this.xVal[e + 1]], t, 0) / h(this.xPct[e], this.xPct[e + 1]);
                var s = (this.xVal[e + 1] - this.xVal[e]) / this.xNumSteps[e],
                  a = Math.ceil(Number(s.toFixed(3)) - 1),
                  i = this.xVal[e] + this.xNumSteps[e] * a;
    ...
    function M(e, t) {
      if (!l(t)) throw new Error("noUiSlider: 'keyboardPageMultiplier' is not numeric.");
      e.keyboardPageMultiplier = t;
    }
    function C(e, t) {
      if (!l(t)) throw new Error("noUiSlider: 'keyboardMultiplier' is not numeric.");
      e.keyboardMultiplier = t;
    }
    function P(e, t) {
      if (!l(t)) throw new Error("noUiSlider: 'keyboardDefaultStep' is not numeric.");
    ...
    function I(e, t) {
      ...
      if (
        ...
        for (s = 1; s < e.handles; s++) a.push(t);
        a.push(!1);
      } else {
    ...
    function $(e, t) {
      if (!l(t)) throw new Error("noUiSlider: 'margin' option must be numeric.");
      0 !== t && (e.margin = e.spectrum.getDistance(t));
    }
    function D(e, t) {
      if (!l(t)) throw new Error("noUiSlider: 'limit' option must be numeric.");
    ...
    function N(e, t) {
      ...
      if (0 !== t) {
        ...
        var a = t[0] + t[1],
          i = e.spectrum.xVal[0];
        if (a / (e.spectrum.xVal[e.spectrum.xVal.length - 1] - i) > 1)
    ...
    function W(e) {
      ...
      e.format && !e.ariaFormat && (e.ariaFormat = e.format),
        Object.keys(s).forEach(function (i) {
          if (r(e[i]) || void 0 !== a[i]) s[i].t(t, r(e[i]) ? e[i] : a[i]);
          else if (s[i].r) throw new Error("noUiSlider: '" + i + "' is required.");
        }),
        (t.pips = e.pips);
      var i = document.createElement('div'),
        n = void 0 !== i.style.msTransform,
        l = void 0 !== i.style.transform;
      t.transformRule = l ? 'transform' : n ? 'msTransform' : 'webkitTransform';
      return (
        (t.style = [
          ['left', 'top'],
          ['right', 'bottom'],
    ...
    function U(t, s, a) {
      var l,
        ...
        k = {},
        A = t.ownerDocument,
        _ = s.documentElement || A.documentElement,
        z = A.body,
      ...
      function $(e, t) {
        var a = O(e, s.cssClasses.origin),
          i = O(a, s.cssClasses.handle);
        if (
          (O(i, s.cssClasses.touchArea),
            ...
            i.addEventListener('keydown', function (e) {
              return (function (e, t) {
                ...
                var a = ['Left', 'Right'],
                  ...
                  r = ['PageDown', 'PageUp'],
                  n = ['Home', 'End'];
                s.dir && !s.ort ? a.reverse() : s.ort && !s.dir && (i.reverse(), r.reverse());
                var l,
                  o = e.key.replace('Arrow', ''),
                  d = o === r[0],
                  c = o === r[1],
                  p = o === i[0] || o === a[0] || d,
                  u = o === i[1] || o === a[1] || c,
                ...
                if ((e.preventDefault(), u || p)) {
                  var h = p ? 0 : 1,
                    g = ge(t)[h];
                  if (null === g) return !1;
                  !1 === g && (g = T.getDefaultStep(C[t], p, s.keyboardDefaultStep)),
                    (g *= c || d ? s.keyboardPageMultiplier : s.keyboardMultiplier),
                    (g = Math.max(g, 1e-7)),
                    (g *= p ? -1 : 1),
                    (l = M[t] + g);
                } else l = f ? s.spectrum.xVal[s.spectrum.xVal.length - 1] : s.spectrum.xVal[0];
                return (
                  pe(t, T.toStepping(l), !0, !0),
                  re('slide', t),
                  re('update', t),
                  re('change', t),
                  re('set', t),
        ...
        return (
          ...
          i.setAttribute('aria-orientation', s.ort ? 'vertical' : 'horizontal'),
          0 === t
            ? u(i, s.cssClasses.handleLower)
            : t === s.handles - 1 && u(i, s.cssClasses.handleUpper),
          (a.handle = i),
          a
        );
      }
      function D(e, t) {
        return !!t && O(e, s.cssClasses.connect);
      }
      function N(e, t) {
        return !(!s.tooltips || !s.tooltips[t]) && O(e.firstChild, s.cssClasses.tooltip);
      }
      function q() {
      ...
      function H() {
        B(),
          (v = p.map(N)),
          ae('update' + E.tooltips, function (e, t, a) {
            if (v && s.tooltips && !1 !== v[t]) {
              var i = e[t];
              !0 !== s.tooltips[t] && (i = s.tooltips[t].to(a[t])), (v[t].innerHTML = i);
            }
          });
      }
      function G(e, t) {
      ...
      function X(t) {
        var s,
          ...
          d = 0;
        return (
          (s = a.slice().sort(function (e, t) {
            return e - t;
          })),
          (a = s.filter(function (e) {
            return !this[e] && (this[e] = !0);
          }, {}))[0] !== r && (a.unshift(r), (l = !0)),
          a[a.length - 1] !== n && (a.push(n), (o = !0)),
          a.forEach(function (s, r) {
            ...
            for (
              ...
              for (
                g = (m = (u = T.toStepping(c)) - d) / (t.density || 1),
                  b = m / (v = Math.round(g)),
                  p = 1;
                p <= v;
                p += 1
              )
                i[(f = d + p * b).toFixed(5)] = [T.fromStepping(f), 0];
              (h =
                a.indexOf(c) > -1
      ...
      function Y(t, a, i) {
        var r,
          ...
          d =
            (((n = {})[e.PipsType.None] = ''),
            (n[e.PipsType.NoValue] = s.cssClasses.markerNormal),
            (n[e.PipsType.LargeValue] = s.cssClasses.markerLarge),
            (n[e.PipsType.SmallValue] = s.cssClasses.markerSub),
            n),
          c = [s.cssClasses.valueHorizontal, s.cssClasses.valueVertical],
          p = [s.cssClasses.markerHorizontal, s.cssClasses.markerVertical];
        function m(e, t) {
          var a = t === s.cssClasses.value,
            i = a ? o : d;
          return t + ' ' + (a ? c : p)[s.ort] + ' ' + i[e];
        }
        return (
          u(l, s.cssClasses.pips),
          u(l, 0 === s.ort ? s.cssClasses.pipsHorizontal : s.cssClasses.pipsVertical),
          Object.keys(t).forEach(function (r) {
            !(function (t, r, n) {
              if ((n = a ? a(r, n) : n) !== e.PipsType.None) {
                var o = O(l, !1);
                (o.className = m(n, s.cssClasses.marker)),
                  (o.style[s.style] = t + '%'),
                  n > e.PipsType.NoValue &&
                    (((o = O(l, !1)).className = m(n, s.cssClasses.value)),
      ...
      function j(e) {
        ...
        return (g = x.appendChild(Y(t, s, a)));
      }
      function F() {
        var e = l.getBoundingClientRect(),
          t = 'offset' + ['Width', 'Height'][s.ort];
        return 0 === s.ort ? e.width || l[t] : e.height || l[t];
      }
      function U(e, t, a, i) {
        var r = function (r) {
            var n,
              ...
              o = (function (e, t, s) {
                ...
                if (a) {
                  var o = function (t) {
                    var a = t.target;
                    return (
                      a === s || s.contains(a) || (e.composed && e.composedPath().shift() === s)
                    );
                  };
                  if ('touchstart' === e.type) {
                    var d = Array.prototype.filter.call(e.touches, o);
                    if (d.length > 1) return !1;
                    (n = d[0].pageX), (l = d[0].pageY);
                  } else {
                    var c = Array.prototype.find.call(e.changedTouches, o);
                    if (!c) return !1;
                    (n = c.pageX), (l = c.pageY);
                  }
                }
                (t = t || f(A)), (i || r) && ((n = e.clientX + t.x), (l = e.clientY + t.y));
                return (e.pageOffset = t), (e.points = [n, l]), (e.cursor = i || r), e;
            ...
            return (
              ...
              !(
                (n.classList
                  ? n.classList.contains(l)
                  : new RegExp('\\b' + l + '\\b').test(n.className)) && !i.doNotReject
              ) &&
                !(e === y.start && void 0 !== o.buttons && o.buttons > 1) &&
                (!i.hover || !o.buttons) &&
                (S || o.preventDefault(), (o.calcPoint = o.points[s.ort]), void a(o, i)))
            );
          },
          n = [];
        return (
          e.split(' ').forEach(function (e) {
            t.addEventListener(e, r, !!S && { passive: !0 }), n.push([e, r]);
          }),
          n
        );
      }
          ...
          c =
            (100 *
              (e -
                ...
                a ? i.top + o.y - n.clientTop : i.left + o.x - n.clientLeft))) /
            F();
        return (c = d(c)), s.dir ? 100 - c : c;
      }
      function Z(e, t) {
        'mouseout' === e.type &&
      ...
      function Q(e, t) {
        if (
          ...
          return J(e, t);
        var a = (s.dir ? -1 : 1) * (e.calcPoint - t.startCalcPoint);
        oe(a > 0, (100 * a) / t.baseSize, t.locations, t.handleNumbers, t.connect);
      }
      function J(e, t) {
        t.handle && (m(t.handle, s.cssClasses.active), (L -= 1)),
          t.listeners.forEach(function (e) {
            _.removeEventListener(e[0], e[1]);
          }),
          0 === L &&
            (m(x, s.cssClasses.drag),
            ce(),
            e.cursor && ((z.style.cursor = ''), z.removeEventListener('selectstart', n))),
      ...
      function ee(e, t) {
        if (!t.handleNumbers.some(V)) {
          ...
          if (1 === t.handleNumbers.length)
            (a = p[t.handleNumbers[0]].children[0]), (L += 1), u(a, s.cssClasses.active);
          e.stopPropagation();
          var i = [],
            r = U(y.move, _, Q, {
              target: e.target,
          ...
          i.push.apply(i, r.concat(l, o)),
            e.cursor &&
              ((z.style.cursor = getComputedStyle(e.target).cursor),
              p.length > 1 && u(x, s.cssClasses.drag),
      ...
      function te(e) {
            ...
            return (
              p.forEach(function (a, i) {
                if (!V(i)) {
                  var r = C[i],
                    n = Math.abs(r - e);
                  (n < t || (n <= t && e > r) || (100 === n && 100 === t)) && ((s = i), (t = n));
                }
              }),
              s
            );
        ...
        !1 !== a &&
          (s.events.snap || o(x, s.cssClasses.tap, s.animationDuration),
          pe(a, t, !0, !0),
          ce(),
          re('slide', a, !0),
          re('update', a, !0),
          s.events.snap ? ee(e, { handleNumbers: [a] }) : (re('change', a, !0), re('set', a, !0)));
      }
      function se(e) {
        var t = K(e.calcPoint),
          s = T.getStep(t),
        ...
        Object.keys(k).forEach(function (i) {
          ...
          e === r &&
            k[i].forEach(function (e) {
              e.call(ve, M.map(s.format.to), t, M.slice(), a || !1, C.slice(), ve);
            });
        });
      }
      function ne(e, t, a, i, r, n, l) {
        var o;
        return (
          p.length > 1 &&
            ...
            (i &&
              t > 0 &&
              ((o = T.getAbsoluteDistance(e[t - 1], s.margin, !1)), (a = Math.max(a, o))),
            r &&
              t < p.length - 1 &&
              ((o = T.getAbsoluteDistance(e[t + 1], s.margin, !0)), (a = Math.min(a, o)))),
          p.length > 1 &&
            s.limit &&
            (i &&
              t > 0 &&
              ((o = T.getAbsoluteDistance(e[t - 1], s.limit, !1)), (a = Math.min(a, o))),
            r &&
              t < p.length - 1 &&
              ((o = T.getAbsoluteDistance(e[t + 1], s.limit, !0)), (a = Math.max(a, o)))),
          s.padding &&
            (0 === t && ((o = T.getAbsoluteDistance(0, s.padding[0], !1)), (a = Math.max(a, o))),
            t === p.length - 1 &&
              ((o = T.getAbsoluteDistance(100, s.padding[1], !0)), (a = Math.min(a, o)))),
          l || (a = T.getStep(a)),
          !((a = d(a)) === e[t] && !n) && a
        );
      }
        ...
        (i = i.slice()),
          ...
          i.length > 1
            ? i.forEach(function (e, s) {
                var a = ne(n, e, n[e] + t, d[s], c[s], !1, o);
                !1 === a ? (t = 0) : ((t = a - n[e]), (n[e] = a));
              })
            : (d = c = [!0]);
        var p = !1;
        i.forEach(function (e, s) {
          p = pe(e, a[e] + t, d[s], c[s], !1, o) || p;
        }),
          p &&
      ...
      function pe(e, t, a, i, r, n) {
        return (
          r || (t = ne(C, e, t, a, i, !1, n)),
          !1 !== t &&
            ((function (e, t) {
              (C[e] = t), (M[e] = T.fromStepping(t));
              var a = 'translate(' + le(de(t, 0) - I + '%', '0') + ')';
              (p[e].style[s.transformRule] = a), ue(e), ue(e + 1);
            })(e, t),
            !0)
        );
      }
      function ue(e) {
        if (h[e]) {
          var t = 0,
            a = 100;
          0 !== e && (t = C[e - 1]), e !== h.length - 1 && (a = C[e]);
          var i = a - t,
            r = 'translate(' + le(de(t, i) + '%', '0') + ')',
            n = 'scale(' + le(i / 100, '1') + ')';
          h[e].style[s.transformRule] = r + ' ' + n;
        }
      }
      function me(e, t) {
        return null === e || !1 === e || void 0 === e
          ...
          : ('number' == typeof e && (e = String(e)),
            !1 !== (e = s.format.from(e)) && (e = T.toStepping(e)),
            !1 === e || isNaN(e) ? C[t] : e);
      }
      function fe(e, t, a) {
        var i = c(e),
          r = void 0 === C[0];
        (t = void 0 === t || t),
          s.animate && !r && o(x, s.cssClasses.tap, s.animationDuration),
          P.forEach(function (e) {
            pe(e, me(i[e], e), !0, !1, a);
          });
        var n = 1 === P.length ? 0 : 1;
        if (r && T.hasNoSize() && ((a = !0), (C[0] = 0), P.length > 1)) {
          var l = 100 / (P.length - 1);
          P.forEach(function (e) {
            C[e] = e * l;
          });
        }
      ...
      function he(e) {
        if ((void 0 === e && (e = !1), e)) return 1 === M.length ? M[0] : M.slice(0);
        var t = M.map(s.format.to);
        return 1 === t.length ? t[0] : t;
      }
      function ge(e) {
        var t = C[e],
          a = T.getNearbySteps(t),
          i = M[e],
          r = a.thisStep.step,
          n = null;
        if (s.snap)
          return [i - a.stepBefore.startValue || null, a.stepAfter.startValue - i || null];
        !1 !== r && i + r > a.stepAfter.startValue && (r = a.stepAfter.startValue - i),
          (n =
            i > a.thisStep.startValue
              ? a.thisStep.step
              : !1 !== a.stepBefore.step && i - a.stepBefore.highestStep),
          100 === t ? (r = null) : 0 === t && (n = null);
        var l = T.countStepDecimals();
        return (
      ...
      u((b = x), s.cssClasses.target),
        0 === s.dir ? u(b, s.cssClasses.ltr) : u(b, s.cssClasses.rtl),
        0 === s.ort ? u(b, s.cssClasses.horizontal) : u(b, s.cssClasses.vertical),
        u(
          b,
        ...
        (l = O(b, s.cssClasses.base)),
        (function (e, t) {
          var a = O(t, s.cssClasses.connects);
          (p = []), (h = []).push(D(a, e[0]));
          for (var i = 0; i < s.handles; i++) p.push($(t, i)), (P[i] = i), h.push(D(a, e[i + 1]));
        })(s.connect, l),
        (w = s.events).fixed ||
          p.forEach(function (e, t) {
            U(y.start, e.children[0], ee, { handleNumbers: [t] });
          }),
        w.tap && U(y.start, l, te, {}),
        w.hover && U(y.move, l, se, { hover: !0 }),
        w.drag &&
          h.forEach(function (e, t) {
            if (!1 !== e && 0 !== t && t !== h.length - 1) {
              var a = p[t - 1],
                ...
                n = [a, i],
                l = [t - 1, t];
              u(e, s.cssClasses.draggable),
                w.fixed && (r.push(a.children[0]), r.push(i.children[0])),
                w.dragAll && ((n = p), (l = P)),
                r.forEach(function (t) {
                  U(y.start, t, ee, { handles: n, handleNumbers: l, connect: e });
                });
            }
          }),
        fe(s.start),
        ...
        s.tooltips && H(),
        ie('update' + E.aria),
        ae('update' + E.aria, function (e, t, a, i, r) {
          P.forEach(function (e) {
            var t = p[e],
              i = ne(C, e, 0, !0, !0, !0),
              n = ne(C, e, 100, !0, !0, !0),
              l = r[e],
              o = String(s.ariaFormat.to(a[e]));
            (i = T.fromStepping(i).toFixed(1)),
              (n = T.fromStepping(n).toFixed(1)),
              (l = T.fromStepping(l).toFixed(1)),
    ...
    var Z = { __spectrum: y, cssClasses: x, create: K };
    (e.create = K),
      (e.cssClasses = x),
      (e.default = Z),
      Object.defineProperty(e, '__esModule', { value: !0 });
  }),
  document.querySelector('.price-filter__slider'))
) {
  let e = document.querySelector('.price-filter__slider');
  noUiSlider.create(e, {
    start: [100, 2e4],
    connect: !0,
    tooltips: [wNumb({ decimals: 0 }), wNumb({ decimals: 0 })],
    range: { min: [100], max: [2e4] },
  });
  const t = document.getElementById('price-start'),
    s = document.getElementById('price-end');
  t.addEventListener('change', setPriceValues), s.addEventListener('change', setPriceValues);
  const a = document.querySelectorAll('.noUi-tooltip');
  function setPriceValues() {
    let a, i;
    '' != t.value && (a = t.value), '' != s.value && (i = s.value), e.noUiSlider.set([a, i]);
  }
  new MutationObserver(() => {
    t.value = a[0].textContent;
  }).observe(a[0], { childList: !0 }),
    new MutationObserver(() => {
      s.value = a[1].textContent;
    }).observe(a[1], { childList: !0 });
}
if (
  ...
  document.querySelector('.menu-page__burger') &&
    document.querySelector('.menu-page__burger').addEventListener('click', function () {
      this.classList.toggle('active'),
        document.querySelector('.menu-page__body').classList.toggle('_open');
    }),
  document.querySelectorAll('.menu-page__parent'))
) {
  const i = document.querySelectorAll('.menu-page__parent');
...
let swiper = new Swiper('.mainslider__body', {
    observer: !0,
    observerParents: !0,
    slidesPerView: 1,
    spaceBetween: 0,
    ...
    speed: 800,
    loop: !0,
    pagination: { el: '.mainslider__dotts', clickable: !0 },
  }),
  subslider = new Swiper('.images-product__subslider', {
    slidesPerView: 4,
    slidesPerGroup: 1,
    spaceBetween: 10,
    speed: 800,
...
new Swiper('.images-product__mainslider', {
  ...
  slidesPerGroup: 1,
  spaceBetween: 0,
  thumbs: { swiper: subslider },
  speed: 800,
  loop: !0,
});
let goods_swiper = new Swiper('.products-slider__item', {
  observer: !0,
  observerParents: !0,
  slidesPerView: 1,
  spaceBetween: 0,
  ...
  navigation: { nextEl: '.products-slider__arrow_next', prevEl: '.products-slider__arrow_prev' },
});
new Swiper('.brands-slider__body', {
  ...
  speed: 800,
  loop: !0,
  navigation: { nextEl: '.brands-slider__arrow_next', prevEl: '.brands-slider__arrow_prev' },
  breakpoints: {
    300: { slidesPerView: 1 },
    450: { slidesPerView: 2 },
    600: { slidesPerView: 3 },
...
if (quantityButtons.length > 0)
  for (let l = 0; l < quantityButtons.length; l++) {
    const o = quantityButtons[l];
    o.addEventListener('click', function (e) {
      let t = parseInt(o.closest('.quantity').querySelector('input').value);
      o.classList.contains('quantity__button_plus') ? t++ : ((t -= 1), t < 1 && (t = 1)),
        1 != t || o.closest('.quantity').classList.contains('_first')
          ? 1 != t &&
            o.closest('.quantity').classList.contains('_first') &&
            o.closest('.quantity').classList.toggle('_first')
          : o.closest('.quantity').classList.toggle('_first'),
        (o.closest('.quantity').querySelector('input').value = t);
    });
  }
const actions_header_parent = document.querySelector('.bottom-header__column'),
  actions_header_new_parent = document.querySelector('.menu__body'),
  actions_header = document.querySelector('.actions-header'),
  callback_parent = document.querySelector('.info-header__column'),
  callback_new_parent = document.querySelector('.bottom-header__column'),
  callback = document.querySelector('.info-header__callback');
if (
  (window.addEventListener('load', function (e) {
    let t = Math.max(document.documentElement.clientWidth, window.innerWidth || 0);
    if (t <= 992 && document.querySelector('.page__content-side')) {
      let e = document.querySelector('.page__content-side');
      document.querySelector('.page__content').insertBefore(e, null);
    }
    if (t <= 770) {
      if (
        (actions_header.classList.contains('load') ||
          (actions_header_new_parent.insertBefore(
            actions_header,
            actions_header_new_parent.children[1],
          ),
          callback_new_parent.insertBefore(callback, callback_new_parent.children[1]),
          actions_header.classList.add('load')),
        document.querySelectorAll('.mainslider__dotts .swiper-pagination-bullet'))
      ) {
        let e = document.querySelectorAll('.mainslider__dotts .swiper-pagination-bullet');
        for (let t = 0; t < e.length; t++)
          e[t].classList.contains('load') &&
            ((e[t].style.backgroundImage = ''), e[t].classList.remove('load'));
      }
    } else if (
      (actions_header.classList.contains('load') &&
        (actions_header_parent.insertBefore(actions_header, actions_header_parent.children[0]),
        callback_parent.insertBefore(callback, callback_parent.children[0]),
        actions_header.classList.remove('load')),
      document.querySelectorAll('.mainslider__dotts .swiper-pagination-bullet'))
    ) {
      let e = document.querySelectorAll('.mainslider__slide'),
        t = document.querySelectorAll('.mainslider__dotts .swiper-pagination-bullet');
      for (let s = 0; s < t.length; s++)
        if (!t[s].classList.contains('load')) {
          let a = getComputedStyle(e[s], null).backgroundImage;
          (t[s].style.backgroundImage = `${a}`), t[s].classList.add('load');
        }
    }
  }),
  window.addEventListener('resize', function (e) {
    ...
    if (t <= 992) {
      if (
        document.querySelector('.page__content-side') &&
        !document.querySelector('.page__content-side').classList.contains('resize')
      ) {
        let e = document.querySelector('.page__content-side');
        document.querySelector('.page__content').insertBefore(e, null),
          console.log('hi'),
      ...
      if (document.querySelector('.filter__title')) {
        let e = document.querySelector('.filter__title');
        e.classList.contains('_active') ||
          (e.classList.toggle('_active'),
          e.addEventListener('click', function (t) {
            e.classList.toggle('_visible');
          }));
      }
    } else if (
      document.querySelector('.page__content-side') &&
      ...
      let e = document.querySelector('.page__content-side');
      document.querySelector('.page__side').insertBefore(e, null), e.classList.remove('resize');
    }
    if (t <= 770) {
      if (
        (actions_header.classList.contains('resize') ||
          (actions_header_new_parent.insertBefore(
            actions_header,
            actions_header_new_parent.children[1],
          ),
          callback_new_parent.insertBefore(callback, callback_new_parent.children[1]),
          actions_header.classList.add('resize')),
        document.querySelectorAll('.mainslider__dotts .swiper-pagination-bullet'))
      ) {
        let e = document.querySelectorAll('.mainslider__dotts .swiper-pagination-bullet');
        for (let t = 0; t < e.length; t++)
          e[t].classList.contains('resize') &&
            ((e[t].style.backgroundImage = ''), e[t].classList.remove('resize'));
      }
    } else if (
      (actions_header.classList.contains('resize') &&
        (actions_header_parent.insertBefore(actions_header, actions_header_parent.children[0]),
        callback_parent.insertBefore(callback, callback_parent.children[0]),
        actions_header.classList.remove('resize')),
      document.querySelectorAll('.mainslider__dotts .swiper-pagination-bullet'))
    ) {
      let e = document.querySelectorAll('.mainslider__slide'),
        t = document.querySelectorAll('.mainslider__dotts .swiper-pagination-bullet');
      for (let s = 0; s < t.length; s++)
        if (!t[s].classList.contains('resize')) {
          let a = getComputedStyle(e[s], null).backgroundImage;
          (t[s].style.backgroundImage = `${a}`), t[s].classList.add('resize');
        }
    }
  }),
  document.querySelector('.search-page__select'))
) {
  let d = document.querySelector('.search-page__select');
  d.addEventListener('click', function (e) {
    d.classList.toggle('_active');
  });
}
if (document.querySelector('._spoller')) {
  let c = document.querySelectorAll('._spoller');
  for (let p = 0; p < c.length; p++)
    c[p].addEventListener('click', function (e) {
      c[p].classList.toggle('_active');
    });
}
if (document.querySelectorAll('.checkbox-categories')) {
  let u = document.querySelectorAll('.checkbox-categories'),
    m = document.querySelector('.search-page__select');
  for (let f = 0; f < u.length; f++) {
    const h = u[f];
    h.addEventListener('change', function (e) {
      h.classList.toggle('_active');
      let t = document.querySelectorAll('.checkbox-categories._active');
      if (t.length > 0) {
        m.classList.add('_categories');
        let e = m.querySelector('.search-page__quantity');
        (e.innerHTML = e.getAttribute('data-text') + t.length),
          console.log(e.getAttribute('data-text'));
      } else m.classList.remove('_categories');
    });
  }
}
if (document.querySelector('.categories-search__column')) {
  let g = document.querySelectorAll('.categories-search__column');
  for (let v = 0; v < g.length; v++)
    g[v].addEventListener('click', function (e) {
      e.stopPropagation();
    });
}
if (document.querySelector('.filter__title')) {
  if (Math.max(document.documentElement.clientWidth, window.innerWidth || 0) <= 992) {
    let b = document.querySelector('.filter__title');
    b.classList.toggle('_active'),
      b.addEventListener('click', function (e) {
        b.classList.toggle('_visible');
      });
  }
}
if (document.querySelector('._tabs')) {
  let w = document.querySelectorAll('._tabs-item'),
    y = document.querySelectorAll('._tabs-block');
  for (let S = 0; S < w.length; S++) {
    let x = w[S],
      E = y[S];
    x.addEventListener('click', function (e) {
      for (let e = 0; e < w.length; e++) w[e].classList.remove('_active');
      for (let e = 0; e < y.length; e++) y[e].classList.remove('_active');
      x.classList.add('_active'), E.classList.add('_active');
    });
  }
}
